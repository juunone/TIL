...
<p style="text-align:center;"><img src="https://hidiki.github.io/webapi-event-handle/browser_handle_click.jpg" alt="browser_handle_click" /></p>
...
> i.e. 의도치 않은 이벤트 전파를 막아주는게 **stopPropagation** 이다.
...
> e.g. a 태그는 적용된 href 속성을 통해 설정된 링크로 페이지 이동을 해주는 기본 기능을 제공한다.  
